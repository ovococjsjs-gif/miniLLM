...
- sequential Multi-Token Prediction loss;
- калькулятор параметров, INT4-памяти, KV-cache, recurrent state и FLOP/token;
- генерируемый MQAR-бенчмарк и первый многосидовый архитектурный скрининг;
- тесты causal-инвариантности, градиентов, роутинга и учёта параметров.
