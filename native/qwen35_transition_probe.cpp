...
static bool wanted_tensor(const std::string & name) {
    return is_layer_tensor(name, "state_predelta") ||
           ...
           is_layer_tensor(name, "q_conv_predelta") ||
           is_layer_tensor(name, "k_conv_predelta") ||
           is_layer_tensor(name, "v_conv_predelta") ||
           is_layer_tensor(name, "gate") ||
           is_layer_tensor(name, "beta_sigmoid") ||
