...
> **Статус:** B0/R1/R2/R3 ниже теперь являются conventional neural controls.
> Каноническая целевая архитектура — событийный каскад AIra-v2 в
> [`aira-v2-audit.md`](aira-v2-audit.md), разделы 5 и 8.
